...
**A practical primer — how the format works internally, and how it differs from Delta Lake and Iceberg.**

A from-the-ground-up explanation of Paimon's internal design: the LSM-tree storage model, merge-on-read, compaction and the read/write table modes, sequence-based ordering, the four merge engines, and the changelog/CDC model — with the Delta Lake and Iceberg contrast drawn out at every step.
...
2. [Delta & Iceberg: the copy-on-write baselines](02-delta-baseline.md)
...
11. [Delta vs Iceberg vs Paimon — at a glance](11-delta-vs-paimon.md)
